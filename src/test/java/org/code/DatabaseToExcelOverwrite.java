...
public class DatabaseToExcelOverwrite {
	...
	public static void main(String[] args) {// Database connection details
		...
		String excelFilePath = "C:\\Users\\impelox-pc-048\\eclipse-workspace\\Demo\\target\\Arshad AIAW Practice - Copy.xlsx";
		...
		try {
			...
			String query = "SELECT * FROM 7003_group_medical_aiaw_transactions.premium where plan_id=2 and status=1;";
			...
			Sheet sheet = workbook.getSheetAt(0); // Modify index if needed
